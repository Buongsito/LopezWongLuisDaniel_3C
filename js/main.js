        ...
        for(let i = 0; i < persons.length; i++){
            content += `
                <tr>
                    ...
                    <td><img src="${ persons[i].newImage }"/></td>
                    <td>
...
// Encode Img as Base 64
const convertirImg = () => {
    var filesSelected = document.getElementById("imgPoke").files;
...
const getUserByIndex = (index) => {
    ...
    for(let i = 0; i < persons.length; i++){
        if(i === index){
            ...
            document.getElementById("imgPoke").value = persons[i].img;
